#!/usr/bin/env python
"""
ubnt_ptp_ac_b_v8.py - AutoConfig UBNT PTP AC REMOTE (ACCESS POINT)
Copyright 2017, KRIPT4

Testing: UBIQUITI POWERBEAM 5AC ISO - FW: XC.v8.0.2 (11/5/2017) = OK
...
## CONFIGURE
driver.find_element_by_xpath('//*[@id="main_menu"]/div/ul/div[2]/a').click()
## END CONFIGURE
...
## NETWORK CONFIG
driver.find_element_by_xpath('//*[@id="settings_navigation"]/ul/li[2]').click()
time.sleep(2)
...
## SERVICES CONFIG
driver.find_element_by_xpath('//*[@id="settings_navigation"]/ul/li[3]').click()
time.sleep(2)
driver.execute_script("window.scrollTo(0, document.body.scrollHeight);")
time.sleep(3)
## END SERVICES CONFIG
...
## SYSTEM CONFIG
driver.find_element_by_xpath('//*[@id="settings_navigation"]/ul/li[4]').click()
time.sleep(2)
